<template>
  ...
  <div class="tabs-container">
    <el-tabs
      ...
      :stretch="true"
    >
      <el-tab-pane label="基础信息" name="WeightPage">
        <weight-page />
      </el-tab-pane>
      <el-tab-pane label="仪表盘" name="WeightReview">
        <weight-review />
      </el-tab-pane>
    </el-tabs>
  </div>
...
import WeightReview from '@/views/weight/WeightReview.vue'

const activeName = ref('WeightPage')
</script>
