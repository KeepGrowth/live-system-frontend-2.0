<template>
  <div
    ...
    <div class="relative z-10 w-full space-y-6 px-4 md:px-8">
      ...
      <div>
        <el-pagination
          class="mt-8 flex justify-center" v-if="okrList.length > 0"
          ...
          :total="total"
          @size-change="fetchOkrData"
          @current-change="fetchOkrData"
        />
      </div>
      <!-- 任务列表网格 -->
      <!--待开始-->
      ...
      <!--已完成-->
      <section class="container mx-auto px-6 -mt-10 relative z-30 mt-10" v-if="finishedOkrs.length>0">
        <div class="flex items-end gap-4 mb-12 border-b border-slate-800 pb-4">
          <h2 class="text-3xl font-bold text-white">
      ...
      <!--已放弃-->
      <section class="container mx-auto px-6 -mt-10 relative z-30 mt-10" v-if="giveUpOkrs.length>0">
        <div class="flex items-end gap-4 mb-12 border-b border-slate-800 pb-4">
          <h2 class="text-3xl font-bold text-white">
